...
public class ActivityLunge extends AppCompatActivity implements OnClickListener {
    ...
    class MyTimer extends CountDownTimer {
        ...
        public void onFinish() {
            ...
            isRunning=false;
            remainMilli=0;
            final MediaPlayer mp = MediaPlayer.create(ActivityLunge.this,R.raw.ding);
            mp.start();
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.Btnnext1:
                Intent intent = new Intent(this, ActivityThread.class);
